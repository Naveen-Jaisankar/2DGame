...
public class NPC_Cycle extends Entity{
	...
	public void getImage() {
		up1 = setup("/npc/oldman_left_1");
		up2 = setup("/npc/oldman_left_1");
		down1 = setup("/npc/oldman_left_1");
		down2 = setup("/npc/oldman_left_1");
		left1 = setup("/npc/oldman_left_1");
		left2 = setup("/npc/oldman_left_1");
		right1 = setup("/npc/oldman_left_1");
		right2 = setup("/npc/oldman_left_1");
	}
	...
	public void update() {
		...
		if(npcIndex!=999 & (gp.keyHandler.fPressed || isInteracted)) {
			if(gp.keyHandler.fPressed) {
				...
				System.out.println("Cycle" + gp.isPlayerInContactWithVehicle);
			}
