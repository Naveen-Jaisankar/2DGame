...
public class TileManager {
	...
	public void getTileImage() {
		...
		setup(122, "door4", true);
		setup(123, "door5", true);
		...
		setup(329, "steel9", true);
		 this.setup(400, "rhouse1", true);
	      ...
	      this.setup(433, "lawn1", false);
	      this.setup(434, "lawn2", false);
	      this.setup(435, "lawn3", false);
	      this.setup(436, "lawn4", false);
	      this.setup(437, "lawn5", false);
	      this.setup(438, "lawn6", false);
	      this.setup(439, "lawn7", false);
	      this.setup(440, "lawn8", false);
	      this.setup(441, "honeycomb", false);
	      ...
	      this.setup(462, "shield1", false);
	      this.setup(463, "shield2", false);
	      this.setup(464, "shield3", false);
	      this.setup(465, "shield4", false);
